...
class AppColors {
  ...
  static const Color scaffoldBg = Color(
    0xFF0E1117,
  ); // الخلفية الأساسية (darker)
  static const Color cardBg = Color(
    0xFF1E1D3D,
  ); // خلفية الكروت (AI Trading Assistant)
  ...
  static const Color searchBarBg = Color(
    0xFF0E1117,
  ); // خلفية شريط البحث (الجديد)
  static const Color panelBg = Color(
    0xFF161B22,
  ); // مستطيلات البطاقات داخل الشاشات
  ...
  // Primary Palette
  static const Color primary = Color(0xFF5646C0); // Electric Purple
  static const Color primaryDark = Color(0xFF262545);
